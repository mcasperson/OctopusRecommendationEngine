...
resource "octopusdeploy_project" "deploy_frontend_project" {
  ...
  lifecycle_id                         = octopusdeploy_lifecycle.lifecycle1.id
  name                                 = "Project A"
...
resource "octopusdeploy_project" "deploy_frontend_project_2" {
  auto_create_release                  = false
  default_guided_failure_mode          = "EnvironmentDefault"
  default_to_skip_if_already_installed = false
  description                          = "Test project"
  ...
  is_discrete_channel_release          = false
  is_version_controlled                = false
  lifecycle_id                         = octopusdeploy_lifecycle.lifecycle2.id
  name                                 = "Project B"
  project_group_id                     = octopusdeploy_project_group.example.id
  tenanted_deployment_participation    = "Untenanted"
  space_id                             = var.octopus_space_id
